...
Shader "Custom/DitherParticle"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( _ParticleColor * tex2DNode25.g ) + ( _LineColor * tex2DNode25.r ) ).rgb;
			o.Alpha = 1.0;
...
/*ASEBEGIN
Version=15500
239;45;1543;983;806.2711;323.5216;1.254473;True;False
...
Node;AmplifyShaderEditor.ColorNode;14;-156.0988,-271.2021;Float;False;Property;_ParticleColor;Particle Color;3;0;Create;True;0;0;False;0;0,0,0,0;0.9811321,0.6062656,0.6062656,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;29;399.2223,-19.50513;Float;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=68C1A1AE4F81A73EE10C5FD56A1EACAE53744B03