Shader "Crosshatch/Glass-Blocker" {
    ...
    Properties {
       ...
       [HideInInspector] _Elapsed("Elapsed", float) = 0
        ...
        _Hit("Collission", Vector) = (0,0,0,0)
        
        _Blocked("Is Blocking", Range(0,1)) = 0
    ...
    SubShader 
    {
        ...
        float4 _Hit;
        uniform float _TransitionState, _Opacity, _Dirtiness, _Blocked, _Elapsed, _AlphaCutoff;
       ...
       //blockerPlayerHole (float2 uv, sampler2D tex, float4 ST, float3 camPos, float3 wPos)
        ...
        void surf (Input i, inout SurfaceOutput o) {
            clip(_AlphaCutoff - blockerPlayerHole(i.uv_texcoord, _AccentMap, _AccentMap_ST, _WorldSpaceCameraPos, i.worldPos));
