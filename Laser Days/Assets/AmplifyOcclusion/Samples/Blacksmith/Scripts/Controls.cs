...
public class Controls : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		GUILayout.EndVertical();
		occlusion.SampleCount = ( AmplifyOcclusionEffect.SampleCountLevel ) ( ( int ) GUILayout.HorizontalSlider( ( float ) occlusion.SampleCount, 0.0f, 3.0f, GUILayout.Width( 100 ) ) );
		GUILayout.Space( 5 );
		GUILayout.BeginVertical();
		GUILayout.Space( -3 );
		GUILayout.Label( "        " );
