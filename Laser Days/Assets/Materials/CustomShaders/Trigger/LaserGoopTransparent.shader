...
Shader "Trigger/LaserGoopTransparent"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_106_0 = ( 1.0 - 0.2 );
			float clampResult104 = clamp( _TransitionState , temp_output_106_0 , 1.0 );
			o.Alpha = ( ( (0.0 + (clampResult104 - temp_output_106_0) * (1.0 - 0.0) / (1.0 - temp_output_106_0)) * _RestingColor.a ) + 0.0 );
		}
...
/*ASEBEGIN
Version=15500
266;190;1273;781;870.8093;804.7284;1.617384;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-334.2775,-13.0995;Float;False;Constant;_Float3;Float 3;10;0;Create;True;0;0;False;0;0.2;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-174.4365,-246.7629;Float;False;Property;_TransitionState;Transition State;5;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2;-19.03012,-690.0654;Float;False;Property;_ShimmerColor;Shimmer Color;1;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0.353501,0.6980392,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=D16FC9B25ACF4956056E06505D6381035393FF09