...
Shader "Trigger/LaserBounceLines"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Alpha = ( _TransitionState * _Color.a * ( tex2DNode1.r * tex2D( _PannerTex, panner8 ).r * tex2D( _TextureSample0, panner94 ).g ) );
		}
...
/*ASEBEGIN
Version=15500
245;94;1273;781;675.2323;784.8214;1.811967;True;False
...
Node;AmplifyShaderEditor.SamplerNode;1;-1220.684,-363.3456;Float;True;Property;_MaskTex;Mask Tex;2;0;Create;True;0;0;False;0;8d83abcffe82e444c885759b7790d3fb;ac961aa805b0a479ca440719853f404c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=DE9E00E09605E082E7CD1C864D1860851116E4AD