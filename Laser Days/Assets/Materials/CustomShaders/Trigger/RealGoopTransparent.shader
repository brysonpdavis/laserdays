...
Shader "Trigger/RealGoopTransparent"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Alpha = ( ( ( 1.0 - (0.0 + (clampResult105 - 0.0) * (1.0 - 0.0) / (0.2 - 0.0)) ) * _RestingColor.a ) + 0.0 );
		}
...
/*ASEBEGIN
Version=15500
266;190;1273;781;1036.966;822.019;1.815865;True;False
...
ASEEND*/
//CHKSM=0E3917FF63AB31DE6882B1DE3B15BD9B8449D9A7