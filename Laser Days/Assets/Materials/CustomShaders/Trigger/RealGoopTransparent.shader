...
Shader "Trigger/RealGoopTransparent"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float clampResult105 = clamp( _TransitionState , 0.0 , 0.05 );
			o.Alpha = ( ( ( 1.0 - (0.0 + (clampResult105 - 0.0) * (1.0 - 0.0) / (0.05 - 0.0)) ) * _RestingColor.a ) + 0.0 );
		}
...
/*ASEBEGIN
Version=15500
449;92;1273;781;1036.966;822.019;1.815865;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-283.9887,-202.374;Float;False;Property;_TransitionState;Transition State;5;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;104;-207.1151,-110.1999;Float;False;Constant;_Float3;Float 3;10;0;Create;True;0;0;False;0;0.05;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;17;-291.813,-986.5856;Float;False;Property;_RestingColor;Resting Color;0;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0,0,0.945098;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;25;-291.7714,-813.7709;Float;False;Property;_ActiveColor;Active Color;2;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.0202019,0.01401744,0.1415094,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;2;13.70356,-733.7186;Float;False;Property;_ShimmerColor;Shimmer Color;1;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0.5960785,1.207843,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0B259ECB907EE66CCB2D598C8817D8F03659B7EA