...
Shader "Trigger/RealGoopOpaque"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( (-0.06 + (sin( ( ( _Time.y + ase_vertex3Pos.y + (-5.0 + (v.color.g - -1.0) * (5.0 - -5.0) / (1.0 - -1.0)) + ase_vertex3Pos.x ) * 2.0 ) ) - -1.0) * (0.06 - -0.06) / (1.0 - -1.0)) * ase_vertexNormal * v.color.r * 1.8 );
		}
...
/*ASEBEGIN
Version=15500
239;45;1543;983;1317.266;177.8152;1.459465;True;False
...
ASEEND*/
//CHKSM=2320CCAFA8406D37F54875D9AADD0551F414894C