...
Shader "Trigger/RealGoopOpaque"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( (-0.06 + (sin( ( ( _Time.y + ase_vertex3Pos.y + (-5.0 + (v.color.g - -1.0) * (5.0 - -5.0) / (1.0 - -1.0)) + ase_vertex3Pos.x ) * 2.0 ) ) - -1.0) * (0.06 - -0.06) / (1.0 - -1.0)) * ase_vertexNormal * v.color.r );
		}
...
/*ASEBEGIN
Version=15500
239;387;1543;983;1722.001;106.2921;1.70275;True;False
...
Node;AmplifyShaderEditor.SamplerNode;1;-255.9204,-415.1375;Float;True;Property;_TriggerMap;Trigger Map;1;0;Create;True;0;0;False;0;None;0f9deff7cdfa54eb0ae31d1428c54bae;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;92;-761.1941,737.3188;Float;False;Constant;_Float1;Float 1;4;0;Create;True;0;0;False;0;5;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;68;-69.6041,435.1256;Float;False;3;3;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=1CD1EA0A651FDE6AA69FAFAD94E38D085345430F