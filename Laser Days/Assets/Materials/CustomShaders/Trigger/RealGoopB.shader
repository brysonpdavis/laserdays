...
Shader "Trigger/RealGoopOpaque"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( (-0.06 + (sin( ( ( _Time.y + ase_vertex3Pos.y + (-5.0 + (v.color.g - -1.0) * (5.0 - -5.0) / (1.0 - -1.0)) + ase_vertex3Pos.x ) * 2.0 ) ) - -1.0) * (0.06 - -0.06) / (1.0 - -1.0)) * ase_vertexNormal * v.color.r * 1.2 );
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;92;-759.4913,732.2105;Float;False;Constant;_Float1;Float 1;4;0;Create;True;0;0;False;0;1.2;0;0;5;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=F30682C946F332B0A0B7C9CE0207970E86215A95