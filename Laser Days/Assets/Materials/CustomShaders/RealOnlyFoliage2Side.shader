...
Shader "Transition/RealOnlyFoliage2Side"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime304 = _Time.y * 0.1;
			float3 ase_vertex3Pos = v.vertex.xyz;
			float3 ase_vertexNormal = v.normal.xyz;
			float4 appendResult305 = (float4(ase_vertexNormal.x , ase_vertexNormal.y , ase_vertexNormal.z , 0.0));
			v.vertex.xyz += ( (0.02 + (sin( ( ( mulTime304 + ( ase_vertex3Pos.x * ase_vertex3Pos.z ) ) * 12.0 ) ) - -1.0) * (0.1 - 0.02) / (1.0 - -1.0)) * appendResult305 ).xyz;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Alpha = 1;
			float CUTOUT289 = tex2DNode78.a;
			clip( ( step( 0.0 , ( -TRANS192 + DISSOLVE199 ) ) * CUTOUT289 ) - _Clip );
		}
...
/*ASEBEGIN
Version=15500
449;92;1273;781;3030.901;-2124.839;1.619979;True;False
...
Node;AmplifyShaderEditor.TFHCRemapNode;293;-1697.092,2230.25;Float;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0.02;False;4;FLOAT;0.1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;290;-1122.986,705.5112;Float;False;289;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;291;-890.7852,556.4704;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;0;10;291;0
WireConnection;0;11;302;0
ASEEND*/
//CHKSM=FB1FF05F63F736BB227FA2D9F659D1CDA83254D8