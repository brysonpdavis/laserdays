...
Shader "ASESampleShaders/Community/DissolveBurnLaser"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_73_0 = ( (-0.7 + (_DissolveAmount - 0.0) * (0.7 - -0.7) / (1.0 - 0.0)) + tex2D( _DisolveGuide, uv_DisolveGuide ).r );
			float clampResult113 = clamp( (-4.0 + (temp_output_73_0 - 0.0) * (4.0 - -4.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
			float3 temp_cast_1 = (( clampResult113 * 0.0 )).xxx;
...
/*ASEBEGIN
Version=15401
9;45;1615;924;1324.258;11.69418;1;True;True
Node;AmplifyShaderEditor.CommentaryNode;128;-967.3727,510.0833;Float;False;908.2314;498.3652;Dissolve - Opacity Mask;4;4;2;73;111;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;129;-892.9326,49.09825;Float;False;814.5701;432.0292;Burn Effect - Emission;4;113;115;112;133;;1,1,1,1;0;0
...
ASEEND*/
//CHKSM=9A6F137B2FC0520E73EAB8AD6532BD9AF923F645