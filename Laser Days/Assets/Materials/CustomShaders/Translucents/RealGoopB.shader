...
Shader "Trigger/RealGoopOpaque"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( (-0.06 + (sin( ( ( _Elapsed + ( ase_vertex3Pos.x * 2.0 ) ) * 2.0 ) ) - -1.0) * (0.06 - -0.06) / (1.0 - -1.0)) * ase_vertexNormal );
		}
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float fresnelNode42 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV42, 0.8 ) );
...
/*ASEBEGIN
Version=15500
422;93;1001;768;496.1595;698.6014;1.753008;True;False
...
Node;AmplifyShaderEditor.ColorNode;17;-495.0202,-939.8713;Float;False;Property;_RestingColor;Resting Color;0;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.05233179,0.1325381,0.2264151,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;2;-41.58624,-669.389;Float;False;Property;_ShimmerColor;Shimmer Color;1;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0,0.144104,0.282353,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;25;-487.9715,-750.7066;Float;False;Property;_ActiveColor;Active Color;2;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.03364186,0.25788,0.3396226,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=69D71CB3ABF3EA2086816585B6791343D784B069