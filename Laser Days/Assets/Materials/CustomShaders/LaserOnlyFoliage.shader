...
Shader "Transition/LaserOnlyFoliage"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult235 = lerp( ( tex2D( _MaterialMap, uv_MaterialMap ).r * tex2D( _pallete, appendResult242.xy ) ) , _InteractColor , ( temp_output_169_0 * _onHover ));
...
/*ASEBEGIN
Version=15500
354;138;1273;781;3340.072;1268.273;1.630999;True;False
...
ASEEND*/
//CHKSM=18D22EC1BC1CAD2F01A52C21676558A8881294A8