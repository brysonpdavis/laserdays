...
Shader "Trigger/RealLineRender"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 lerpResult22 = lerp( _Color0 , _Color1 , ( 1.0 - clampResult10 ));
			o.Emission = lerpResult22.rgb;
			float2 uv_TextureSample0 = i.uv_texcoord * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
			o.Alpha = ( _Color0.a * tex2D( _TextureSample0, uv_TextureSample0 ).r * ( 1.0 - _TransitionState ) );
		}
...
/*ASEBEGIN
Version=15500
146;98;1273;781;1465.999;401.7071;1.609789;False;False
Node;AmplifyShaderEditor.DepthFade;6;-1116.555,-183.3452;Float;False;True;1;0;FLOAT;0.12;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-567.7362,408.0169;Float;False;Property;_TransitionState;Transition State;3;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2;-492.233,-98.65509;Float;False;Property;_Color0;Color 0;2;0;Create;True;0;0;False;0;0,0,0,0;0,0.5452871,0.8113207,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;25;-496.9057,84.44917;Float;False;Property;_Color1;Color 1;1;0;Create;True;0;0;False;0;0,0,0,0;0,0.5452871,0.8113207,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-575.9495,213.6791;Float;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B7EC459103999CA8E85F4D93EB2AA9A88068D149