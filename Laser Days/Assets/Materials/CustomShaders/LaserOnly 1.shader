...
Shader "Transition/LaserGrass"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float4 lerpResult235 = lerp( ( tex2DNode78.r * lerpResult171 ) , _InteractColor , ( temp_output_169_0 * _onHover ));
			float4 lerpResult172 = lerp( lerpResult235 , _InteractColor , ( temp_output_169_0 * _onHold ));
			float4 DIFFUSE173 = lerpResult172;
			o.Emission = DIFFUSE173.rgb;
			...
			float4 SHIMMER224 = ( _ShimmerColor * step( 0.4 , ( tex2D( _EffectMap, uv_EffectMap ).b * ( tex2D( _EffectMap, panner216 ).g + 0.34 ) ) ) * HOLD240 * _Flippable * _Shimmer );
			float4 temp_output_229_0 = SHIMMER224;
			o.Specular = temp_output_229_0.rgb;
			o.Alpha = 1;
			float TRANS175 = _TransitionState;
			float DISSOLVE178 = tex2D( _EffectMap, uv_EffectMap ).r;
			float MASK245 = tex2DNode78.a;
			clip( ( step( 1.0 , ( TRANS175 + DISSOLVE178 ) ) * MASK245 ) - _Clip );
		}
...
/*ASEBEGIN
Version=15500
234;130;1162;807;2113.967;1029.1;2.032185;True;False
...
Node;AmplifyShaderEditor.ColorNode;168;-1676.749,-908.2079;Float;False;Property;_InteractColor;Interact Color;5;0;Create;True;0;0;False;0;0.25,0.25,0.25,0.4;0.7735849,0.1787999,0.2275959,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;206;-2229.896,-887.77;Float;False;Property;_ColorLaser;Color Laser;3;0;Create;True;0;0;False;0;0.5,0.5,0.5,0.2;0.8431372,0.4941176,0.4823529,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;205;-2233.577,-1076.185;Float;False;Property;_ColorReal;Color Real;4;0;Create;True;0;0;False;0;0.5,0.5,0.5,0.2;0.764151,0.764151,0.764151,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;207;-2234.643,-703.2306;Float;False;Property;_TransitionStateB;Transition State B;9;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-2254.27,-351.1039;Float;True;Property;_EffectMap;Effect Map;2;0;Create;True;0;0;False;0;None;2a93c58e6f7fa49f98a7420432a57b02;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;4;-2235.168,-459.7347;Float;False;Property;_TransitionState;Transition State;8;1;[PerRendererData];Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;242;-1456.763,1465.219;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0.34;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;219;-1438.485,1162.745;Float;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;187;-1677.815,748.2719;Float;False;Property;_ShimmerColor;Shimmer Color;7;1;[HDR];Create;True;0;0;False;0;8,8,8,0;10.03291,2.994114,2.994114,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;236;-1217.437,1134.011;Float;True;2;0;FLOAT;0.4;False;1;FLOAT;0.09;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;143;-647.905,135.6709;Float;True;2;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;245;-1524.634,-460.089;Float;False;MASK;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;246;-597.9567,364.979;Float;False;245;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;157;-2268.772,-115.0031;Float;True;Property;_Normal;Normal;1;0;Create;True;0;0;False;0;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.5;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;156;-2410.029,576.6994;Float;False;Property;_EdgeThickness;Edge Thickness;6;0;Create;True;0;0;False;0;0.3560508;0.056;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;241;-586.6895,6.53949;Float;False;Property;_Smoothness;Smoothness;15;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;243;-397.0671,158.9091;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-212.0929,-140.4752;Float;False;True;2;Float;ASEMaterialInspector;0;0;StandardSpecular;Transition/LaserGrass;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;3;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.27;True;True;0;True;Opaque;;AlphaTest;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;4;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;1;False;-1;1;False;-1;0;False;2;0.7608291,0.9622642,0.1770203,0;VertexOffset;True;True;Spherical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;True;192;0;0;0;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
WireConnection;216;0;215;0
WireConnection;216;1;234;0
WireConnection;217;1;216;0
WireConnection;169;0;168;4
WireConnection;169;1;237;0
WireConnection;242;0;217;2
...
WireConnection;243;0;143;0
WireConnection;243;1;246;0
WireConnection;204;1;156;0
WireConnection;198;0;156;0
WireConnection;0;2;174;0
WireConnection;0;3;229;0
WireConnection;0;10;243;0
ASEEND*/
//CHKSM=BBBCF20209CB9A85FF0F779E7B284215B037B9B9