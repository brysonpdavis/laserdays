Shader "Crosshatch/DetailPatch" {

    Properties {
        
        _MainTex("Material Map", 2D) = "white" {}
    
        [NoScaleOffset] _AccentMap("Mask Map", 2D) = "white" {}
        [HideInInspector][NoScaleOffset] _EffectMap("Effect Map", 2D) = "white" {}
        ...
        _ZFightOffset("Z-Fighting Offset", Range(0.0001, 0.0009)) = 0.0001
    ...
    SubShader {
        ...
        Pass {
            ...
            #include "CrosshatchOtherIncludes.cginc"
